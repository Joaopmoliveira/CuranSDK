...
namespace curan
{
    namespace ui
    {
        ...
        std::unique_ptr<MutatingTextPanel> MutatingTextPanel::make()
        {
            std::unique_ptr<MutatingTextPanel> editor = std::unique_ptr<MutatingTextPanel>(new MutatingTextPanel());
            return editor;
        }

        MutatingTextPanel::MutatingTextPanel(const std::string &in_default_text) : default_text{in_default_text}
        {
            auto font_manager = SkFontMgr::RefDefault();
            fEditor.setFontMgr(font_manager);
        ...
        {
            std::unique_ptr<MutatingTextPanel> editor = std::unique_ptr<MutatingTextPanel>(new MutatingTextPanel(in_default_text));
            return editor;
        }
