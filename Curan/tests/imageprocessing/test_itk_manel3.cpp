...
main(int argc, char * argv[])
{
  ...
  optimizer->SetNumberOfIterations(700);
  ...
  double RotationAlongX = finalParameters[3];
  double RotationAlongY = finalParameters[4];
  double RotationAlongZ = finalParameters[5];
