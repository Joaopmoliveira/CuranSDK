  ...
  geometry.vertices[11] = {       0  , -0.5000  , -0.3090};
        ...
        Cube::Cube(double xExtent, double yExtent, double zExtent, Alignemnt align)
        {
            ...
            if (align == Alignemnt::CORNER_ALIGNED)
            {
                ...
                Eigen::Matrix<double, 3, 1> offset{xExtent / 0.5, yExtent / 0.5, zExtent / 0.5};
        ...
        OpenCylinder::OpenCylinder(uint32_t numAxisSamples, uint32_t numRadialSamples, float radius, float height, Alignemnt align)
        {
            Factory factory;
