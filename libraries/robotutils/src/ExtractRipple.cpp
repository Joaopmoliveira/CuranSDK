...
namespace robotic {
    ...
    EigenState&& ExtractRipple::update(const RobotModel<number_of_joints>& iiwa, EigenState&& eigen_state, Eigen::Matrix<double,Eigen::Dynamic,Eigen::Dynamic>& composed_task_jacobians){
        ...
        */
        ...
        for(size_t torque_joint_i = 0; torque_joint_i < number_of_joints; ++torque_joint_i){
            ...
            eigen_state.user_defined[torque_joint_i] = current_torque_joint_i;
        }
