...
namespace curan {
	namespace display {
		...
		Context::~Context() {
			...
			static VKAPI_ATTR VkBool32 VKAPI_CALL Context::debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageType, const VkDebugUtilsMessengerCallbackDataEXT* pCallbackData, void* pUserData)
			{
		...
		std::ostream& operator<<(std::ostream& out, const Context& o) {
