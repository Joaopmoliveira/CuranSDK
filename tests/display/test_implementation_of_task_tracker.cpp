...
int main() {
  try {
    ...
    std::unique_ptr<curan::ui::DicomViewer<std::uint8_t>> image_display_x =
        curan::ui::DicomViewer<std::uint8_t>::make(resources, &vol, Direction::X);
    std::unique_ptr<curan::ui::DicomViewer<std::uint8_t>> image_display_y =
        curan::ui::DicomViewer<std::uint8_t>::make(resources, &vol, Direction::Y);
    std::unique_ptr<curan::ui::DicomViewer<std::uint8_t>> image_display_z =
        curan::ui::DicomViewer<std::uint8_t>::make(resources, &vol, Direction::Z);
