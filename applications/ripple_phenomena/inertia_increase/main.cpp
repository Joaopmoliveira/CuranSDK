...
#include "robotutils/InertiaAugmentation.h"
...
int main(){
    std::unique_ptr<curan::robotic::InertiaAugmentation> handguinding_controller = std::make_unique<curan::robotic::InertiaAugmentation>();
