...
struct ProcessingMessage {
	std::mutex mut;
	curan::utilities::CircularBuffer<ObservationEigenFormat> ringged_recorder;
	...
	curan::ui::Button* button = nullptr;
	curan::ui::Button* button_start_collection = nullptr;
	...
	ProcessingMessage(curan::ui::ImageDisplay* in_processed_viwer,
		curan::ui::OpenIGTLinkViewer* in_open_viwer, ConfigurationData& in_configuration) : processed_viwer{ in_processed_viwer }, open_viwer{ in_open_viwer }, configuration{ in_configuration }, ringged_recorder{1000}
	{
	}
