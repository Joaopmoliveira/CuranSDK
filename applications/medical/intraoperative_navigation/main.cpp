...
int main(){
    try{
        ...
        auto convert_to_world = [&](Eigen::Vector3d point_in_moving){
            ...
            in_moving_coordinates[0] = 1e3*point_in_moving[0];
            in_moving_coordinates[1] = 1e3*point_in_moving[1];
            in_moving_coordinates[2] = 1e3*point_in_moving[2];
            Eigen::Vector4d in_world_coordinates = registration_data.moving_to_fixed_transform()*in_moving_coordinates;
        ...
        process_info.f_entry_point = convert_to_world(trajectory_data.entry());
        ...
        process_info.f_registration = registration_data.moving_to_fixed_transform();
